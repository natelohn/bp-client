...
function App() {
    const [callSignUp] = useMutation(REGISTER_MUTATION, { client: apoloClient });
    const [callLogin] = useMutation(LOGIN_MUTATION, { client: apoloClient });
    const { loading, error, data } = useQuery(USER_ID_QUERY, { client: apoloClient });
